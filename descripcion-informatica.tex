...
\subsection{Seguimiento de la cobertura}
...
El paquete dockerMiddleware dispone de una cobertura de test del 42,02\%

Dentro de cada fichero de test se encuentran los diferentes test

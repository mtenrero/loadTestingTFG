...
Docker añade una capa para gestionar las redes de los contenedores dotándolos de una IP propia y el sistema de ficheros a LXC. Permite especificar imágenes de contenedores autocontenidas y gestionar un ciclo de vida sobre éstos. 
\cite{containerVsHyper}\newline

...
Es un framework enfocado al diseño de la \acrshort{API} en primer lugar, y es lo que hace a este framework único. Posee su propio lenguaje \acrshort{DSL} (lenguaje descriptivo) en el que antes de codificar, obliga al programador a pensar en el diseño de la \acrshort{API}, ya que esta debe ser definida en un primer lugar. Permite definir desde el endpoint, el contenido que consumirá y los parámetros que recibirá.\newline
...
Amazon Web Services es una solución Platform-as-a-Service (\acrshort{PAAS}) que ofrece diversos productos, entre ellos:

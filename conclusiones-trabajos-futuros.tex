...
La utilización del middleware \gls{ATQ} reduce drásticamente el tiempo de setup de la infraestructura necesaria para ejecutar tests de manera elástica. Ya que con unos sencillos comandos es posible desplegarla de una manera rápida, transparente y eficiente.\newline

...
Normalmente se sitúan en la cima esta pirámide los tests de sistema o End-To-End (\gls{E2E}) ya que el coste de éstos es muy elevado al requerir que todos los componentes de la aplicación se encuentren operativos en el momento de realización de las pruebas y al ser más frágiles. Los test de rendimiento se encuentran justo en esta cima.  
